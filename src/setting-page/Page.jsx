...
export const Page = () => {
	const { status, updating, errorMessages, updateStatus, updateValues, values } = useSettings();
	...
	return (
		<>
			{!updating && status && (
				<Notice isDismissable level={status} onDismiss={() => updateStatus(null)}>
					<strong>
						{status === 'success'
			...
			>
					...
					<table className="form-table" role="presentation">
						<tbody>
							<tr>
								...
								<td>
									<TextField
										isInvalid={errorMessages?.greeting ?? false}
				...
				<div className="submit">
					<Button isDisabled={updating} prefix={updating && <Spinner />} type="submit">
						{updating
